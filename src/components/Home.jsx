      ...
      <div className="max-w-[85%] mx-auto font-inter grid grid-cols-1 md:grid-cols-2 gap-8 items-center  min-h-screen">
        ...
        <div className="order-2 lg:order-1 flex flex-col items-center md:items-start justify-start space-y-5 text-center md:text-left">
          <h1 className="text-3xl md:text-5xl font-bold">
            I’m <span className="text-[#fe5617]">Sanjeevi Ram</span>
          </h1>
          ...
          I am Sanjeevi Ram, a passionate Artificial Intelligence and Data Science student with a strong foundation in web development,
          design, and machine learning. I specialize in building creative, user-focused solutions—ranging from intelligent systems 
          to visually compelling websites. With a deep interest in blending technology and design, 
          I aim to deliver innovative digital experiences that are both functional and aesthetically engaging.
          </p>
          ...
          <div className=" flex flex-col space-y-3 md:space-y-0 md:flex-row md:gap-6 text-lg md:text-xl font-semibold ">
            ...
            <div className="flex items-center gap-3">
              ...
              <span>8610519536</span>
            </div>
            <div className="flex items-center gap-3">
              <FaEnvelope className="text-[#fe5617]" size={20} />
              <span>sanjeeviram422@gmail.com</span>
            </div>
          </div>
          {/* Button */}
          <div className="bg-[#fe5617] px-5 py-2 rounded-2xl font-bold ">
            <a href="https://drive.google.com/file/d/13j2bTdAMS-a8_AaT8JPjLKHbqM3S-0jq/view?usp=sharing">View CV</a>
          </div>
        </div>
